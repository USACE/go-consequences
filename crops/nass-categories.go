...
func NASSCropMap() map[string]Crop {
	...
	m["2"] = Crop{ID: 2, Name: "Cotton"}
	m["3"] = Crop{ID: 3, Name: "Rice"}
	m["4"] = Crop{ID: 4, Name: "Sorghum"}
	m["5"] = Crop{ID: 5, Name: "Soybeans"}
	m["6"] = Crop{ID: 6, Name: "Sunflower"}
	m["10"] = Crop{ID: 10, Name: "Peanuts"}
	m["11"] = Crop{ID: 11, Name: "Tobacco"}
	m["12"] = Crop{ID: 12, Name: "Sweet Corn"}
	m["13"] = Crop{ID: 13, Name: "Pop or Orn Corn"}
	m["14"] = Crop{ID: 14, Name: "Mint"}
	m["21"] = Crop{ID: 21, Name: "Barley"}
	m["22"] = Crop{ID: 22, Name: "Durum Wheat"}
	m["23"] = Crop{ID: 23, Name: "Spring Wheat"}
	m["24"] = Crop{ID: 24, Name: "Winter Wheat"}
	m["25"] = Crop{ID: 25, Name: "Other Small Grains"}
	m["26"] = Crop{ID: 26, Name: "Dbl Crop WinWht/Soybeans"}
	m["27"] = Crop{ID: 27, Name: "Rye"}
