...
func TestHSIP(t *testing.T) {
	...
	rw, _ := resultswriters.InitSpatialResultsWriter_EPSG_Projected("/workspaces/Go_Consequences/data/sct_base_data.gpkg", "criticalInfrastructure", string(resultswriters.GPKG), 4326)
	defer rw.Close()
